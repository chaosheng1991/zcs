			...
			<div class="span3">
				<div class="sidebar-nav">
					...
					<ul id="dashboard-menu" class="nav nav-list collapse in">
						...
						<li><a href="<%=basePath%>content/my" 
							style="background: #e8e8e8">与我有关</a></li>
							...
							<div class="block-body collapse in">
								...
								<p>
									...
									<fmt:formatDate value="${data.submit_time}"
										pattern="yyyy-MM-dd HH:mm" />&nbsp;&nbsp;&nbsp;&nbsp;是否开放:<c:if test="${data.is_out_view==0}">是</c:if>
										<c:if test="${data.is_out_view==1}">否</c:if>&nbsp;&nbsp;&nbsp;&nbsp;开放时间:
